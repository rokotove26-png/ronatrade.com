class RealAuthHeadInjector {
  element(element) {
    element.prepend('<script id="rona-g82-real-auth-entry-loader-v1" src="/assets/g82/portal-real-auth-entry-v1.js" defer></script><script id="rona-g82-inline-auth-loader-v2" src="/assets/g82/portal-home-inline-auth-v2.js?v=20260919-auth-failover-v3" defer></script>', { html: true });
  }
}

const HOME = new Set(['/pages/home_large','/pages/home_large.html','/pages/home_compact','/pages/home_compact.html']);
...
export async function onRequest(context) {
  ...
  headers.set('x-rona-inline-auth-entry', 'g8.2-inline-auth-failover-v3');
