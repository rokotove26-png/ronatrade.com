...
'use strict';
if(window.__RONA_OWNER_MARKET_NEWS_CANONICAL_V2__)return;
window.__RONA_OWNER_MARKET_NEWS_CANONICAL_V2__=true;
...
function renderMarketNews(){
  ...
  if(host.dataset.ronaMarketNewsCanonical==='v2'&&host.dataset.ronaMarketNewsSignature===signature&&q(':scope > .rona-news-hero',host)&&q(':scope > .rona-news-filter',host))return true;
  host.dataset.ownerPage='market-news';
  host.dataset.ronaMarketNewsCanonical='v2';
  host.dataset.ronaMarketNewsSignature=signature;
  const hero=e('section',{class:'rona-visual-hero rona-news-hero','data-rona-news-canonical':'v2'},e('div',{},e('h1',{class:'rona-visual-title',text:'Новости топливного рынка СНГ'})));
