...
const BUILD='payments-v8-admin-ui-v4-canonical-passport-takeover-20260917';
...
export async function onRequest(){
  return new Response(SCRIPT,{status:200,headers:{
    ...
    'x-rona-payments-passport-routing':'canonical-v8-takeover-v2',
