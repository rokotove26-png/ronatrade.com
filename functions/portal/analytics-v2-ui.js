...
;(()=>{'use strict';
  ...
  function render(){
    ...
    r.replaceChildren();r.dataset.ronaLiveRoot='owner-bootstrap-v2';r.dataset.publicationId=String(current.publication_id||'');
  ...
  function liveDomIsCurrent(r){
    ...
    return r.dataset.ronaLiveRoot==='owner-bootstrap-v2'&&r.dataset.publicationId===id&&!!r.querySelector('.an2-live-current')&&!!r.querySelector('[data-rona-live-chart="v2"]');
  }
