...
function radioEnsureCanonicalPoller(){
  ...
  window.__RONA_ADMIN_RADIO_MESSAGE_CANONICAL_POLLER__=setInterval(async()=>{
    const p=page('radio');if(document.visibilityState!=='visible'||!p?.classList.contains('active'))return;
