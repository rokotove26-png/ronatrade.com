...
import adminVisualRedesign from './admin-visual-redesign-v1.js';
import adminVisualStatusChips from './admin-visual-status-chips-v1.js';
import adminVisualPolish from './admin-visual-polish-v1.js';
import adminVisualRevisionV2 from './admin-visual-revision-v2.js';
import adminVisualRevisionV2Polish from './admin-visual-revision-v2-polish.js';
import adminVisualRevisionV2Finalize from './admin-visual-revision-v2-finalize.js';
import adminVisualRevisionV3Fix from './admin-visual-revision-v3-fix.js';
import adminVisualV4Finalize from './admin-visual-v4-finalize.js';
import adminVisualV5HomeFallback from './admin-visual-v5-home-fallback.js';
...
export async function onRequest(context){
  ...
  const patched=source.replace(BUCKET_FROM,BUCKET_TO).replace(ACTIONS_FROM,ACTIONS_TO).replace(ADMIN_BOOTSTRAP_FROM,ADMIN_BOOTSTRAP_TO)+applicationPassportRuntime+adminVisualRedesign+adminVisualStatusChips+adminVisualPolish+adminVisualRevisionV2+adminVisualRevisionV2Polish+adminVisualRevisionV2Finalize+adminVisualRevisionV3Fix+adminVisualV4Finalize+adminVisualV5HomeFallback;
  ...
  headers.set('x-rona-admin-visual-v3','frosted-glass-v3.2');
  headers.set('x-rona-admin-visual-v4','layered-frosted-glass-v4');
