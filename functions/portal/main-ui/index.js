...
export async function onRequest(context){
  ...
  const patched=source.replace(BUCKET_FROM,BUCKET_TO).replace(ACTIONS_FROM,ACTIONS_TO)+applicationPassportRuntime;
  ...
  headers.set('x-rona-application-passport','v1');
