...
function paymentsV7OpenDesignerPassport(trigger){
  ...
  const titleBlock=e('div',{},
    ...
    e('div',{class:'rona-payments-v7-designer-meta'},
      ...
      e('span',{},'Статус сделки: ',e('strong',{text:typeof paymentsV7OwnerDealStatusText==='function'?paymentsV7OwnerDealStatusText(deal?.financial_status):'Статус уточняется'}))
    )
  );
