...
(()=>{'use strict';
const VERSION='20260920-executive-v5-visible-compression';
...
function install(){
  ...
  s.textContent=[
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi h2,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card>h2{margin:0 0 4px!important;color:color-mix(in srgb,var(--dx-accent) 48%,#e8f2f6)!important;font-size:12px!important;line-height:1.18!important;font-weight:880!important;letter-spacing:-.015em}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi .rona-owner-kpi,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card .rona-owner-kpi{margin:0 0 3px!important;color:color-mix(in srgb,var(--dx-accent) 28%,#fff)!important;font-size:clamp(25px,1.7vw,29px)!important;line-height:1!important;font-weight:920!important;letter-spacing:-.045em!important;font-variant-numeric:tabular-nums;text-shadow:0 0 14px color-mix(in srgb,var(--dx-accent) 11%,transparent),0 8px 22px rgba(0,0,0,.24)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi .rona-owner-muted,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card .rona-owner-muted{color:#93aaba!important;font-size:9.8px!important;line-height:1.28!important;font-weight:650}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(1)>h2{color:#b8f1ff!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(2)>h2{color:#ffe0a4!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(3)>h2{color:#bfd6ff!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(4)>h2{color:#bcefd5!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(5)>h2{color:#b8f1ff!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(6)>h2{color:#bcefd5!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(1){background:linear-gradient(90deg,rgba(22,85,111,.38),rgba(5,16,27,.94) 58%,rgba(4,14,23,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(2){background:linear-gradient(90deg,rgba(107,74,24,.36),rgba(17,17,20,.95) 58%,rgba(6,14,22,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(3){background:linear-gradient(90deg,rgba(35,67,110,.34),rgba(6,17,29,.95) 58%,rgba(4,14,23,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(4){background:linear-gradient(90deg,rgba(24,86,70,.34),rgba(5,17,27,.95) 58%,rgba(4,14,23,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(5){background:linear-gradient(90deg,rgba(20,82,108,.32),rgba(5,17,28,.95) 58%,rgba(4,14,23,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(6){background:linear-gradient(90deg,rgba(24,88,71,.34),rgba(5,17,27,.95) 58%,rgba(4,14,23,.92))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter{display:flex!important;gap:6px!important;align-items:center;flex-wrap:wrap;margin:0!important;padding:5px 6px!important;border:1px solid rgba(126,204,241,.13)!important;border-bottom:0!important;border-radius:13px 13px 0 0!important;background:linear-gradient(180deg,rgba(6,20,32,.72),rgba(3,13,22,.66))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025),0 12px 28px rgba(0,0,0,.13)!important;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button{min-height:30px!important;padding:0 12px!important;border:1px solid rgba(126,177,207,.15)!important;border-radius:9px!important;background:rgba(6,18,29,.56)!important;color:#9fb5c3!important;font-size:11px!important;line-height:1!important;font-weight:850!important;letter-spacing:.005em!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025);transition:transform .15s ease,border-color .15s ease,background .15s ease,color .15s ease}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-active{border-color:rgba(99,220,255,.43)!important;background:linear-gradient(180deg,rgba(53,165,214,.25),rgba(20,82,116,.18))!important;box-shadow:inset 0 0 0 1px color-mix(in srgb,currentColor 34%,transparent)!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-attention{border-color:rgba(255,200,111,.42)!important;background:linear-gradient(180deg,rgba(179,114,31,.23),rgba(92,58,20,.17))!important;box-shadow:inset 0 0 0 1px color-mix(in srgb,currentColor 30%,transparent)!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-completed{border-color:rgba(88,227,188,.40)!important;background:linear-gradient(180deg,rgba(39,153,115,.22),rgba(18,78,61,.17))!important;box-shadow:inset 0 0 0 1px color-mix(in srgb,currentColor 30%,transparent)!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-annulled{border-color:rgba(255,113,128,.42)!important;background:linear-gradient(180deg,rgba(174,53,69,.22),rgba(83,31,40,.17))!important;box-shadow:inset 0 0 0 1px color-mix(in srgb,currentColor 30%,transparent)!important}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table>h2{margin:0 0 10px!important;color:#f6fbff!important;font-size:20px!important;line-height:1.15!important;font-weight:900!important;letter-spacing:-.024em}',
...
function apply(){
  ...
  root.dataset.ronaDealsVisual='premium-executive-v5';
}
let queued=false;
