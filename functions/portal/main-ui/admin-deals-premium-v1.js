...
window.__RONA_ADMIN_DEALS_PREMIUM_V1__='20260920-executive-v4-integrated-hierarchy';
...
function install(){
  ...
  s.textContent=[
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:10px!important;margin-bottom:8px!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi{--dx-accent:var(--dx-cyan);position:relative;overflow:hidden;min-height:92px!important;margin:0!important;padding:12px 16px!important;border:1px solid color-mix(in srgb,var(--dx-accent) 30%,transparent)!important;border-radius:16px!important;background:radial-gradient(250px 135px at 100% 0,color-mix(in srgb,var(--dx-accent) 13%,transparent),transparent 72%),linear-gradient(145deg,rgba(11,28,44,.96),rgba(5,16,27,.91))!important;box-shadow:0 14px 34px rgba(0,0,0,.23),inset 3px 0 0 color-mix(in srgb,var(--dx-accent) 76%,transparent),inset 0 1px 0 rgba(255,255,255,.045)!important;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter{display:flex!important;gap:7px!important;align-items:center;flex-wrap:wrap;margin:0 0 6px!important;padding:6px 7px!important;border:1px solid rgba(126,204,241,.13)!important;border-radius:13px!important;background:linear-gradient(180deg,rgba(6,20,32,.72),rgba(3,13,22,.66))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025),0 12px 28px rgba(0,0,0,.13)!important;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button{min-height:33px!important;padding:0 13px!important;border:1px solid rgba(126,177,207,.15)!important;border-radius:9px!important;background:rgba(6,18,29,.56)!important;color:#9fb5c3!important;font-size:11.5px!important;line-height:1!important;font-weight:850!important;letter-spacing:.005em!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025);transition:transform .15s ease,border-color .15s ease,background .15s ease,color .15s ease}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table{position:relative;overflow:hidden;margin:0!important;padding:14px 18px 18px!important;border:1px solid rgba(129,211,248,.25)!important;border-radius:17px!important;background:radial-gradient(760px 220px at 48% 0,rgba(36,112,151,.08),transparent 72%),linear-gradient(145deg,rgba(4,17,28,.988),rgba(2,11,19,.98))!important;box-shadow:0 26px 68px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.045)!important;backdrop-filter:blur(22px) saturate(118%);-webkit-backdrop-filter:blur(22px) saturate(118%)}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table>h2{margin:0 0 12px!important;color:#f6fbff!important;font-size:20px!important;line-height:1.15!important;font-weight:900!important;letter-spacing:-.024em}',
