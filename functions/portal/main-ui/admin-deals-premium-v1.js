...
window.__RONA_ADMIN_DEALS_PREMIUM_V1__='20260914-executive-v1';
...
function install(){
  ...
  s.textContent=[
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:12px!important;margin-bottom:12px!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi{--dx-accent:var(--dx-cyan);position:relative;overflow:hidden;min-height:116px!important;margin:0!important;padding:16px 17px!important;border:1px solid color-mix(in srgb,var(--dx-accent) 27%,transparent)!important;border-radius:15px!important;background:radial-gradient(240px 130px at 100% 0,color-mix(in srgb,var(--dx-accent) 12%,transparent),transparent 72%),linear-gradient(145deg,rgba(11,28,44,.95),rgba(5,16,27,.88))!important;box-shadow:0 18px 42px rgba(0,0,0,.27),inset 3px 0 0 color-mix(in srgb,var(--dx-accent) 68%,transparent),inset 0 1px 0 rgba(255,255,255,.045)!important;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card:hover,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi:hover{transform:translateY(-2px);border-color:color-mix(in srgb,var(--dx-accent) 42%,transparent)!important;box-shadow:0 24px 50px rgba(0,0,0,.32),0 0 24px color-mix(in srgb,var(--dx-accent) 7%,transparent),inset 3px 0 0 color-mix(in srgb,var(--dx-accent) 78%,transparent)!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(1){--dx-accent:#63dcff}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(2){--dx-accent:#ff9d73}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(3){--dx-accent:#c3a5ff}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(4){--dx-accent:#58e3bc}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(5){--dx-accent:#65a9ff}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>*:nth-child(6){--dx-accent:#ffc86f}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi h2,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card>h2{margin:0 0 8px!important;color:#d8e7ef!important;font-size:12.5px!important;line-height:1.18!important;font-weight:850!important;letter-spacing:-.012em}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi .rona-owner-kpi,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card .rona-owner-kpi{margin:0 0 5px!important;color:#fff!important;font-size:clamp(25px,2vw,31px)!important;line-height:1!important;font-weight:920!important;letter-spacing:-.045em!important;font-variant-numeric:tabular-nums;text-shadow:0 10px 26px rgba(0,0,0,.30)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-kpi .rona-owner-muted,html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid>.rona-owner-card .rona-owner-muted{color:#7f9bad!important;font-size:9.5px!important;line-height:1.32!important;font-weight:650}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter{display:flex!important;gap:8px!important;align-items:center;flex-wrap:wrap;margin:2px 0 13px!important;padding:0!important;border:0!important;background:transparent!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button{min-height:34px!important;padding:0 13px!important;border:1px solid rgba(126,177,207,.20)!important;border-radius:10px!important;background:rgba(6,18,29,.68)!important;color:#9fb5c3!important;font-size:10.5px!important;line-height:1!important;font-weight:850!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025);transition:transform .15s ease,border-color .15s ease,background .15s ease,color .15s ease}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-active{border-color:rgba(99,220,255,.43)!important;background:linear-gradient(180deg,rgba(53,165,214,.25),rgba(20,82,116,.18))!important;box-shadow:inset 0 0 0 1px rgba(99,220,255,.18),0 8px 20px rgba(0,0,0,.18)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-attention{border-color:rgba(255,200,111,.42)!important;background:linear-gradient(180deg,rgba(179,114,31,.23),rgba(92,58,20,.17))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-completed{border-color:rgba(88,227,188,.40)!important;background:linear-gradient(180deg,rgba(39,153,115,.22),rgba(18,78,61,.17))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-filter button[aria-pressed="true"].is-annulled{border-color:rgba(255,113,128,.42)!important;background:linear-gradient(180deg,rgba(174,53,69,.22),rgba(83,31,40,.17))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table{position:relative;overflow:hidden;margin:0!important;padding:16px!important;border:1px solid rgba(125,207,244,.21)!important;border-radius:17px!important;background:linear-gradient(145deg,rgba(6,20,32,.965),rgba(3,13,22,.94))!important;box-shadow:0 24px 60px rgba(0,0,0,.32),inset 0 1px 0 rgba(255,255,255,.04)!important;backdrop-filter:blur(18px) saturate(125%);-webkit-backdrop-filter:blur(18px) saturate(125%)}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table>h2{margin:0 0 13px!important;color:#f6fbff!important;font-size:16px!important;font-weight:900!important;letter-spacing:-.02em}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table-wrap{overflow:auto!important;border:1px solid rgba(124,196,230,.16)!important;border-radius:13px!important;background:rgba(2,10,17,.50)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025)}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table{width:100%!important;min-width:1280px!important;border-collapse:separate!important;border-spacing:0!important;font-size:12.5px!important;font-variant-numeric:tabular-nums}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table thead th{position:sticky;top:0;z-index:2;padding:10px 10px!important;border-bottom:1px solid rgba(125,205,241,.18)!important;background:linear-gradient(180deg,rgba(12,31,47,.99),rgba(7,22,34,.99))!important;color:#7898ac!important;font-size:9px!important;line-height:1.15!important;font-weight:900!important;letter-spacing:.075em!important;text-transform:uppercase;white-space:nowrap}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table tbody td{padding:9px 10px!important;border-bottom:1px solid rgba(118,171,201,.095)!important;background:rgba(4,15,24,.72)!important;color:#dce8ef!important;font-size:12.5px!important;line-height:1.26!important;vertical-align:middle!important;transition:background .14s ease,color .14s ease}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table tbody tr:last-child td{border-bottom:0!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table tbody tr:hover td{background:linear-gradient(180deg,rgba(14,38,56,.96),rgba(7,25,39,.96))!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table th:nth-child(1),html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table td:nth-child(1){color:#8ce6ff!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table th:nth-child(2){color:#c9c0ff!important}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-table .rona-owner-table td:nth-child(2){color:#eeeaff!important;white-space:normal!important;min-width:190px;max-width:250px;overflow-wrap:anywhere}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-id{font-weight:900!important;letter-spacing:.01em!important;color:#9eeaff!important;text-shadow:0 0 18px rgba(99,220,255,.10)}',
    'html.rona-deals-premium-v1 #page-deals .rona-fin-pill{min-height:25px!important;padding:4px 8px!important;border-radius:999px!important;font-size:9px!important;font-weight:850!important;letter-spacing:.02em!important;box-shadow:inset 0 0 16px rgba(255,255,255,.018)}',
    ...
    'html.rona-deals-premium-v1 #page-deals .rona-deal-open,html.rona-deals-premium-v1 #page-deals .rona-deal-detail-btn{min-height:31px!important;padding:0 11px!important;border:1px solid rgba(99,220,255,.34)!important;border-radius:8px!important;background:linear-gradient(180deg,rgba(35,112,153,.36),rgba(17,67,95,.28))!important;color:#d8f7ff!important;font-size:10px!important;font-weight:900!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 7px 18px rgba(0,0,0,.18);transition:transform .14s ease,border-color .14s ease,box-shadow .14s ease}',
    'html.rona-deals-premium-v1 #page-deals .rona-deal-open:hover,html.rona-deals-premium-v1 #page-deals .rona-deal-detail-btn:hover{transform:translateY(-1px);border-color:rgba(118,231,255,.62)!important;box-shadow:0 10px 24px rgba(24,127,177,.16),inset 0 1px 0 rgba(255,255,255,.06)}',
    ...
    '@media(max-width:1100px){html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}',
    '@media(max-width:720px){html.rona-deals-premium-v1 #page-deals>.rona-owner-page-content,html.rona-deals-premium-v1 #page-deals .rona-owner-page-content[data-owner-page="deals"]{padding:14px 12px 28px!important}html.rona-deals-premium-v1 #page-deals .rona-deal-kpi-grid{grid-template-columns:1fr!important}html.rona-deals-premium-v1 #page-deals .rona-deal-table{padding:11px!important}}',
...
function apply(){
  ...
  root.dataset.ronaDealsVisual='premium-executive-v1';
}
let queued=false;
