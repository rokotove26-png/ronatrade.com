...
(()=>{'use strict';
const VERSION='20260920-executive-v6-current-dom-selectors';
...
function apply(){
  ...
  root.dataset.ronaDealsVisual='premium-executive-v6-current-dom-selectors';
}
let queued=false;
