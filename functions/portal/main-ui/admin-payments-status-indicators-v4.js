...
function installStyle(){
  for(const id of ['ronaAdminPaymentsStatusBadgesV1','ronaAdminPaymentsStatusBadgesV2','ronaAdminPaymentsStatusBadgesV3'])document.getElementById(id)?.remove();
  if(document.getElementById('ronaAdminPaymentsStatusIndicatorsV4'))return;
