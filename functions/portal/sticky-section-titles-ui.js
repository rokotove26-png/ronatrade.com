...
window.__RONA_STICKY_SECTION_TITLES_V2__='20260823-2310';
...
function headerBottom(){
  ...
  qa('header,[role="banner"],.topbar,.toolbar,.app-header,.header').forEach(function(n){
    ...
    if((pos!=='fixed'&&pos!=='sticky')||r.width<window.innerWidth*.45||r.height<=0||r.height>140||r.top>6||r.bottom<=0)return;
