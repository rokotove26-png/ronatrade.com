...
export async function onRequest(context){
  ...
  if(url.pathname==='/portal/client'){
    ...
    headers.set('x-rona-client-price-sync','safe-v12-authoritative-price');
