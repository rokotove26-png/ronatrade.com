...
async function radioRefreshCanonicalNow(reason='runtime'){
  ...
  window.__RONA_ADMIN_RADIO_MESSAGE_REFRESH_STATE__={
    ...
    count:radioCanonicalItems().length,
