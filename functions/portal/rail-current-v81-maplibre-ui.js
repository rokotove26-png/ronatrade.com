...
const V821_MARKER="window.__RONA_RAIL_CURRENT_V81__='20260825-raster-first-v8.2.1';";
...
export async function onRequest(context){
  ...
  if(
    ...
    return new Response('RAIL_V821_SOURCE_MISMATCH',{status:500,headers:{
  ...
  source=source
    ...
    .replace(V7_MARKER,V821_MARKER)
    .replace("version:'v7'","version:'v8.2.1'")
  ...
  headers.set('x-rona-rail-ui','current-v8.2.1-raster-first-readable');
