...
const V82_MARKER="window.__RONA_RAIL_CURRENT_V81__='20260825-raster-first-v8.2';window.__RONA_RAIL_VISUAL_V85__='20260918-compact-dark-v8.5';";
...
const REPAIR_RUNTIME=String.raw`window.__RONA_RAIL_CURRENT_REPAIR_VERSION__='20260918-owner-v3-compact-dark';
function ensureRailCompactDarkStyle(){
  ...
  var s=el('style');s.id='ronaRailCompactDarkStyle';s.textContent=[
    '#page-monitoring>.rona-owner-page-content{width:100%!important;max-width:1260px!important;margin:0 auto!important;padding-bottom:18px!important}',
    '.rona-rail-v4-root{gap:10px!important;width:100%!important}',
    '.rona-rail-v4-work{display:grid!important;grid-template-columns:minmax(330px,.92fr) minmax(520px,1.45fr)!important;gap:10px!important;align-items:start!important}',
    '.rona-rail-v4-left{gap:10px!important;min-width:0!important}',
    ...
    '.rona-rail-v4-card h2{margin:0 0 10px!important;color:#e9f6fb!important;font-size:18px!important;line-height:1.18!important;font-weight:830!important;letter-spacing:-.012em!important}',
    ...
    '.rona-rail-v4-kpi span{font-size:11px!important;line-height:1.2!important;color:#91a9b7!important;opacity:1!important}',
    '.rona-rail-v4-kpi strong{margin-top:5px!important;font-size:26px!important;line-height:1!important;font-weight:880!important;color:#eef9fd!important;font-variant-numeric:tabular-nums!important}',
    ...
    '.rona-rail-v7-real{min-height:340px!important;margin-bottom:8px!important;border:1px solid rgba(86,189,219,.22)!important;border-radius:14px!important;background:#06131f!important;box-shadow:0 14px 32px rgba(0,0,0,.24)!important}',
    '.rona-rail-v7-real .rona-rail-v4-map-canvas{inset:38px 7px 38px!important;border:1px solid rgba(96,210,238,.13)!important;border-radius:10px!important;background:#061522!important;box-shadow:inset 0 0 0 1px rgba(2,12,20,.72),0 8px 20px rgba(0,0,0,.22)!important}',
    '.rona-rail-v7-map-viewport{border:0!important;outline:0!important;border-radius:9px!important;background:#061522!important;box-shadow:none!important}',
    '.rona-rail-v7-map-viewport:after{content:""!important;position:absolute!important;inset:0!important;z-index:5!important;pointer-events:none!important;background:linear-gradient(180deg,rgba(4,22,34,.10),rgba(3,15,24,.22))!important;mix-blend-mode:multiply!important}',
    '.rona-rail-v7-tile{filter:grayscale(1) invert(.91) brightness(.50) contrast(1.24) sepia(.16) hue-rotate(145deg) saturate(.92)!important;opacity:.96!important}',
    ...
    '.rona-rail-v4-matrix-preserved{width:100%!important;max-width:1260px!important;margin:0 auto!important;padding:14px 16px!important;border-radius:15px!important;background:linear-gradient(160deg,rgba(7,21,34,.94),rgba(4,14,24,.90))!important;border-color:rgba(104,183,219,.16)!important;box-shadow:0 12px 28px rgba(0,0,0,.17)!important}',
    ...
    '#page-monitoring>.rona-owner-page-content>section,#page-monitoring>.rona-owner-page-content>.rona-owner-card{max-width:1260px!important;margin-left:auto!important;margin-right:auto!important}',
    '@media(max-width:1180px){#page-monitoring>.rona-owner-page-content{max-width:100%!important}.rona-rail-v4-work{grid-template-columns:minmax(310px,.92fr) minmax(470px,1.38fr)!important}.rona-rail-v7-real{min-height:325px!important}}',
...
export async function onRequest(context){
  ...
  source=source.split('if(matrix)host.append(matrix);').join("if(matrix){matrix.classList.add('rona-rail-v4-matrix-preserved');host.append(matrix);}");

  const headers=new Headers(response.headers);
  headers.set('cache-control','no-store, no-cache, must-revalidate');
  headers.set('pragma','no-cache');
  headers.set('expires','0');
  headers.set('x-rona-rail-ui','current-v8.5-compact-dark');
