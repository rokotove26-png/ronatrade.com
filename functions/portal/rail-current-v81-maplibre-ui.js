...
const REPAIR_RUNTIME="window.__RONA_RAIL_CURRENT_REPAIR_VERSION__='20260918-owner-v1';window.__RONA_RAIL_CURRENT_REPAIR__=function(){try{paint();sync();return true}catch(_e){return false}};function waitAdminReady(){";
...
export async function onRequest(context){
  ...
  headers.set('x-rona-rail-ui','current-v8.3-owner-repair');
