...
const V82_MARKER="window.__RONA_RAIL_CURRENT_V81__='20260825-raster-first-v8.2';window.__RONA_RAIL_VISUAL_V86__='20260918-balanced-dark-v8.6';";
...
const REPAIR_RUNTIME=String.raw`window.__RONA_RAIL_CURRENT_REPAIR_VERSION__='20260918-owner-v4-balanced-dark';
function ensureRailCompactDarkStyle(){
  ...
  var s=el('style');s.id='ronaRailCompactDarkStyle';s.textContent=[
    '#page-monitoring>.rona-owner-page-content{width:100%!important;max-width:1320px!important;margin:0 auto!important;padding-bottom:18px!important}',
    '.rona-rail-v4-root{gap:10px!important;width:100%!important}',
    '.rona-rail-v4-work{display:grid!important;grid-template-columns:minmax(390px,.98fr) minmax(560px,1.42fr)!important;gap:10px!important;align-items:start!important}',
    ...
    '.rona-rail-v7-map-viewport:after{content:""!important;position:absolute!important;inset:0!important;z-index:5!important;pointer-events:none!important;background:linear-gradient(180deg,rgba(8,38,56,.04),rgba(3,18,29,.10))!important;mix-blend-mode:normal!important}',
    '.rona-rail-v7-tile{filter:grayscale(.72) invert(.72) brightness(.86) contrast(1.07) sepia(.08) hue-rotate(155deg) saturate(.72)!important;opacity:.98!important}',
    ...
    '.rona-rail-v4-matrix-preserved{width:100%!important;max-width:1320px!important;margin:8px auto 0!important;padding:14px 16px!important;border-radius:15px!important;background:linear-gradient(160deg,rgba(7,21,34,.94),rgba(4,14,24,.90))!important;border-color:rgba(104,183,219,.16)!important;box-shadow:0 12px 28px rgba(0,0,0,.17)!important}',
...
export async function onRequest(context){
  ...
  headers.set('x-rona-rail-ui','current-v8.6-balanced-dark');
