...
if(window.__RONA_ANALYTICS_APPROVED_V455__==='retired-compat-guard-v1')return;
window.__RONA_ANALYTICS_APPROVED_V455__='retired-compat-guard-v1';
function scrub(){
...
export async function onRequest(){return new Response(SCRIPT,{status:200,headers:{'content-type':'application/javascript; charset=utf-8','cache-control':'no-store, no-cache, must-revalidate','pragma':'no-cache','expires':'0','x-content-type-options':'nosniff','x-rona-analytics-approved':'retired-compat-guard-v1'}})}
