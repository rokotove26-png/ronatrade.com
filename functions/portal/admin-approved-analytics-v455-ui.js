...
if(window.__RONA_ANALYTICS_APPROVED_V455__==='retired-compat-guard-v2')return;
window.__RONA_ANALYTICS_APPROVED_V455__='retired-compat-guard-v2';
function scrub(){
...
function loadCanonicalAccess(){
  ...
  s.src='/portal/admin-canonical-create-access-v441-ui?v=20260828-canonical-v441';
  s.async=false;
  s.dataset.ronaCanonicalAccessV441='true';
