...
export async function onRequest(context) {
  ...
  headers.set('x-rona-client-admin-sync','role-v3-contract-authoritative-deal-v5-canonical-compact-v2-price-bounded');
  ...
  if(source.includes('rona-client-deal-canonical-visual-v2-loader'))return new Response(source,{status:response.status,statusText:response.statusText,headers});
  const runtime=source.includes('rona-client-deal-documents-v5-loader')?CLIENT_DEAL_CANONICAL_VISUAL_RUNTIME:CLIENT_ADMIN_SYNC_RUNTIME;
