...
export async function onRequest(context) {
  ...
  headers.set('x-rona-client-admin-sync','contract-v2-single-logout-v2-deal-documents-v1-4-one-line-cta');
