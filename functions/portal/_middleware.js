...
export async function onRequest(context) {
  ...
  headers.set('x-rona-client-admin-sync','role-v3-contract-authoritative-deal-v4-cabinet-canonical-price-bounded');
  ...
  const html=source.includes('rona-client-deal-documents-v4-loader')?source:source.replace('</head>',CLIENT_ADMIN_SYNC_RUNTIME+'</head>');
