...
-- Direct resource denial: deletion occurs at transaction completion, with NO reconciliation call.
begin;
update portal_private.client_applications set status='REJECTED',decision_reason='ISOLATED_RESOURCE_DENIED'
 where application_id=test_application_v2.get('delivered_receipt')::jsonb->>'application_id';
commit;
