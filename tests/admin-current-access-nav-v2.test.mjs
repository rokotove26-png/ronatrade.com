...
assert(source.includes("window.__RONA_CLIENTS_AGENTS_CURRENT__='20260826-single-owner-v3'"),'Current Clients/Agents v3 marker missing');
...
assert(source.includes("'x-rona-access-create':'client-agent-v3'"),'Access-create response marker missing');
