...
test('Split wagon histories preserve cohort geometry but visually use the legacy route line',()=>{
  ...
  assert.match(v81,/rona-rail-v7-cohort-line\{fill:none;stroke:#9f332f;stroke-width:4\.2/);
