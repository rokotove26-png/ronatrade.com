...
for(const target of ['/admin-runtime-shell-v3','/admin-runtime-access-v3','/admin-runtime-watchdog-v3'])assert(route.includes(target),`Admin route critical runtime rewrite missing: ${target}`);
