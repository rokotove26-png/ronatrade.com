...
const [shell,priceSync,priceConditions,logoutVisual,applications,directory,marketIntelligence,marketNews]=await Promise.all([
...
console.log('PERPETUAL_CLIENT_POLLING_REMOVED=SHELL_PRICE_CONDITIONS_LOGOUT_VISUAL_APPLICATIONS_DIRECTORY_MARKET');
