...
assert.match(home,/owner\.style\.width=tr\.width\+'px';owner\.style\.maxWidth=tr\.width\+'px'/);
assert.match(home,/owner\.innerHTML=renderLivebar/);
assert.match(home,/whenCurrentProjection/);
assert.doesNotMatch(home,/renderSignature|detailSignature/);
