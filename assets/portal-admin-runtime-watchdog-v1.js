...
window.__RONA_ADMIN_RUNTIME_WATCHDOG__='page-aware-v6-home-hidden-fallback-safe';
const sleep=ms=>new Promise(resolve=>setTimeout(resolve,ms));
const state=window.__RONA_ADMIN_RUNTIME_RECOVERY__={version:'page-aware-v6-home-hidden-fallback-safe',status:'BOOTING',pageAttempts:Object.create(null),events:[],lastError:null};
