...
window.__RONA_ADMIN_RUNTIME_WATCHDOG__='page-aware-v5-market-news-content-health';
const sleep=ms=>new Promise(resolve=>setTimeout(resolve,ms));
const state=window.__RONA_ADMIN_RUNTIME_RECOVERY__={version:'page-aware-v5-market-news-content-health',status:'BOOTING',pageAttempts:Object.create(null),events:[],lastError:null};
