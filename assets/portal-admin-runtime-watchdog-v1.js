...
#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head{width:100%!important;max-width:none!important;min-height:92px!important;margin:0!important;padding:15px 18px 14px!important;box-sizing:border-box!important;display:flex!important;align-items:center!important;justify-content:flex-start!important;gap:0!important;grid-column:1/-1!important;background:radial-gradient(250px 150px at 94% 0%,rgba(71,176,226,.085),transparent 72%),linear-gradient(135deg,rgba(10,28,45,.985),rgba(7,20,34,.975))!important;background-image:radial-gradient(250px 150px at 94% 0%,rgba(71,176,226,.085),transparent 72%),linear-gradient(135deg,rgba(10,28,45,.985),rgba(7,20,34,.975))!important;border:1px solid rgba(88,166,204,.19)!important;border-radius:16px!important;box-shadow:0 13px 30px rgba(0,0,0,.14),inset 0 1px rgba(255,255,255,.025)!important;filter:none!important;position:relative!important;overflow:hidden!important;z-index:2!important}
#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head:before{content:""!important;display:block!important;position:absolute!important;right:72px!important;bottom:0!important;width:230px!important;height:1px!important;background:linear-gradient(90deg,transparent,rgba(86,209,255,.14),transparent)!important;pointer-events:none!important;z-index:0!important}
#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head:after{content:""!important;display:block!important;position:absolute!important;width:118px!important;height:118px!important;right:-24px!important;top:-68px!important;border:1px solid rgba(92,206,247,.095)!important;border-radius:50%!important;box-shadow:0 0 0 16px rgba(92,206,247,.018),0 0 0 34px rgba(92,206,247,.011)!important;pointer-events:none!important;z-index:0!important}
...
#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head .rona-radio-clean-sub{margin:7px 0 0!important;padding:0!important;max-width:620px!important;font-size:10.5px!important;line-height:1.4!important;color:#7894a5!important;text-align:left!important;background:none!important;background-image:none!important;border:0!important;box-shadow:none!important;filter:none!important}
@media(max-width:640px){#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head{min-height:82px!important;padding:14px 15px 13px!important}#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head .rona-radio-clean-title{font-size:26px!important}#page-messages>.rona-rs-root[data-kind="radio"]>.rona-radio-clean-head:after{right:-52px!important;top:-76px!important}}
