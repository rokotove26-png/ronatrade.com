...
function resourceFixture(){
  ...
  window.RONA_CLIENT_CONTEXT={whenReady:async()=>clone(window.__qaResourceCurrent),getCurrentContext:()=>clone(window.__qaResourceCurrent),getCurrentProjection:()=>projection(),invalidateCurrentProjection:()=>true,whenCurrentProjection:async()=>projection(),subscribe:fn=>{window.__qaResourceSubscribers.push(fn);return()=>{window.__qaResourceSubscribers=window.__qaResourceSubscribers.filter(x=>x!==fn)}}};
