...
const src='/assets/portal-runtime/client-application-lifecycle-v1.js?v=20260829-resource-archive-v1';
const marker='20260829-client-application-resource-archive-v1';
...
integrity.client_runtime.application_lifecycle_bridge={id,src,marker,archive_trigger:'RESOURCE_CONFIRMED'};
