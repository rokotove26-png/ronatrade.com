...
if(!paymentsRuntime.includes("source:'CURRENT_CONTEXT_FINANCE_PROJECTION'")||!paymentsRuntime.includes('RONA_CLIENT_CONTEXT')||!paymentsRuntime.includes('authority.subscribe')||!paymentsRuntime.includes("mode:'EVENT_DRIVEN'")||!paymentsRuntime.includes('polling:false'))throw new Error('CLIENT_PAYMENTS_FINANCE_CURRENT_CONTEXT_SOURCE_MISSING');
