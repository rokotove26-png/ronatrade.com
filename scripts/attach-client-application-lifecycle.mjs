...
const homeRuntimePath='dist/assets/portal-runtime/client-home-authoritative-v1.js';
...
const homeId='rona-client-home-authoritative-v1';
...
const homeSrc='/assets/portal-runtime/client-home-authoritative-v1.js?v=20260830-current-only-authoritative-v1';
...
const homeMarker='20260830-client-home-authoritative-v1';
...
if(!homeRuntime.includes("source:'CLIENT_CONTEXT_HOME_PROJECTION'")||!homeRuntime.includes('/v1/client/bootstrap')||!homeRuntime.includes('/v1/client/context?clientId='))throw new Error('CLIENT_HOME_SERVER_PROJECTION_CONTRACT_MISSING');
if(!homeRuntime.includes('data-rona-client-home-owner')||!homeRuntime.includes('data-rona-home-canonical-width'))throw new Error('CLIENT_HOME_CURRENT_ONLY_OWNER_MISSING');
...
if(html.includes(homeId)||html.includes('client-home-authoritative-v1.js')||html.includes(homeGuardId))throw new Error('CLIENT_HOME_BRIDGE_ALREADY_PRESENT');
...
integrity.client_runtime.home_bridge={id:homeId,src:homeSrc,marker:homeMarker,source:'CLIENT_CONTEXT_HOME_PROJECTION',scope:'SELECTED_AUTHORIZED_CLIENT_CONTRACT',mode:'CURRENT_ONLY_CONSOLIDATED_HOME',active_deals:'SERVER_DEAL_STATUS',commercial_context:'SERVER_LINKED_APPLICATION',payment_summary:'SERVER_RESOLVED_FINANCE',payment_events:'SERVER_FILTERED_CLIENT_PAYMENTS',resource_status:'SERVER_RESOLVED_RESOURCE_STATE',refresh_ms:30000,context_switch:'AUTOMATIC_FROM_AUTHORIZED_CONTEXT',duplicates_removed:true,hardcoded_business_entities:false,first_paint_guard:{id:homeGuardId,mode:'HOME_FAIL_CLOSED',fail_closed:true}};
...
console.log(`CLIENT_APPLICATION_LIFECYCLE_BRIDGE=PASS sha256=${integrity.client_runtime.emitted_sha256} bytes=${emitted.length}; server connection indicator ${connectionId}; authoritative client home ${homeId}; server-resolved deal state strip enabled; payment sanitation ${paymentsSanitationId}; authoritative client payments ${paymentsId}; canonical payments layout ${paymentsCanonicalId}`);