...
const src='/assets/portal-runtime/client-application-lifecycle-v1.js?v=20260829-operations-authoritative-state-v4';
const marker='20260829-client-operations-authoritative-state-v4';
...
integrity.client_runtime.application_lifecycle_bridge={id,src,marker,source:'AUTHORITATIVE_CLIENT_CONTEXT',archive_trigger:'RESOURCE_CONFIRMED',deal_status_source:'OPERATIONS_DIRECTOR/AUTHORITATIVE_DEALS',deal_amount_presentation:'BADGE_WITHOUT_LABEL'};
