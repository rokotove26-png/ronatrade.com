...
const access=await retry('Clients/Agents current semantic convergence',async attempt=>{
  ...
  assert(!t.includes('openWithoutContract'),'retired pre-PDF access flag returned');
