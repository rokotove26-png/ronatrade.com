...
need(has(operationsV87,"paymentActionRows=financeCurrentKnown?currentDueDeals:paymentControl"),'Operations Command Center V8.7 canonical due-now action rows are missing');
