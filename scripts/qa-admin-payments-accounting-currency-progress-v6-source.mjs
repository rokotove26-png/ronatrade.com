...
pass('REAL_PREVIEW_BROWSER_NO_SYNTHETIC_DOM',browser.includes("origin+'/portal/main-ui'")&&!browser.includes('page.setContent(')&&!browser.includes('addScriptTag(')&&!browser.includes("import runtime from '../functions"));
