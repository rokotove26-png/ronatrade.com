...
console.log(JSON.stringify({status:'SYSTEM_ADMIN_OWNER_REMEDIATION=PASS',canonical_source:true,deals_owner:'AUTHORITATIVE_LIST_ONLY_REAL_DEALS_ROOT',company_kpi:'AUTHORITATIVE_CURRENT_CONTEXT_TOTALS',typography:{runtime:'RONA_CLIENT_OWNER_TYPOGRAPHY_110_V3_COMPUTED',effective_scale:1.1,analytics_effective_scale:1}}));
