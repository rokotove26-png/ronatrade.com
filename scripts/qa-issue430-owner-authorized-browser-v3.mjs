...
const proof={suite:'ISSUE430_OWNER_AUTHORIZED_BROWSER_V3',head:HEAD,origin:ORIGIN,sessions:[],cleanup:[],runtimeErrors:{c005:[],multi:[]},navigation:null,c005:null,multi:null};
try{
