...
console.log(`ADMIN_CURRENT_STATIC_MODULES=PASS access=${Buffer.byteLength(access)} claims=${Buffer.byteLength(claims)} remaining=${Buffer.byteLength(remaining)} analytics=${Buffer.byteLength(analytics)} accessOwner=clients-agents-current-v5 radioOwner=STAGE_2A_CORRECTIVE_CLIENT_CHAT_V3_STATIC_OWNER radioRead=/v1/admin/radio/bootstrap analyticsOwner=approved-v432-exclusive analyticsSource=RONA_Admin_LK_LOCAL_v4_3_2_Analytics_PricingBridge_Ready_Local.html newsOwner=dedicated-asset-v1`);