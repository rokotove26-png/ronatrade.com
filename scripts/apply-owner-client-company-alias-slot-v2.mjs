...
if(!build.includes('/assets/portal-runtime/client-contract-download-v3.js?v=20260911-company-directory-canonical-claim-v12'))throw new Error('COMPANY_ALIAS_CANONICAL_BUILD_SRC_MISSING');
