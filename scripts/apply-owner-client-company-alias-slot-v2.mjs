...
if(!runtime.includes("const MARK='20260906-client-contract-v10-kpi-typography-dynamic-owner';"))throw new Error('COMPANY_ALIAS_CANONICAL_RUNTIME_MISSING');
...
if(!build.includes('/assets/portal-runtime/client-contract-download-v3.js?v=20260906-company-directory-kpi-typography-v10'))throw new Error('COMPANY_ALIAS_CANONICAL_BUILD_SRC_MISSING');
