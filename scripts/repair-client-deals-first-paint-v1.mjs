...
for(const token of [
  ...
  "d?.confirmed_quantity_tonnes??a?.quantity_tonnes", "d?.passport_unit_price", "d?.passport_currency"
...
if(integrity?.client_runtime?.deals_authoritative_renderer){
  Object.assign(integrity.client_runtime.deals_authoritative_renderer,{
    ...
    economics_source:'authoritative-current-context-deal-projection',
    confirmed_quantity_source:'owner-deal-workflow-confirmed-volume',
