...
console.log('CLIENT_MARKET_INTELLIGENCE_QA=PASS current-context preload isolated; one Client news renderer; Analytics/News open+context-change+explicit-invalidation only; periodic polling absent');
