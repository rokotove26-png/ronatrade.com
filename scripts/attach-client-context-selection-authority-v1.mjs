...
integrity.client_runtime.context_selection_authority={
  ...
  visual_context_binding:'CLIENT_ID_CONTRACT_ID_DIRECT_SLOT_RENDER',native_deal_bridge:'CURRENT_PROJECTION_TO_NATIVE_OPEN_DEAL_ONLY',transient_surface_policy:'CLOSE_NATIVE_DRAWER_SYNCHRONOUSLY_ON_CONTEXT_SWITCH'
};
