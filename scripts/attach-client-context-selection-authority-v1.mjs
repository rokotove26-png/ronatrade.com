...
for(const token of [
  ...
  'data-rona-current-context-slot','legacyContextScopes','bindLegacyScope','bindHeaderSlots','renderSlot','CURRENT_SLOT','legacyProjectionDeals'
...
integrity.client_runtime.context_selection_authority={
  ...
  visual_context_binding:'CLIENT_ID_CONTRACT_ID_DIRECT_SLOT_RENDER',native_deal_bridge:'CURRENT_PROJECTION_TO_NATIVE_OPEN_DEAL_ONLY'
};
