...
console.log(`CLIENT_SECTION_FIRST_PAINT=PASS sha256=${integrity.client_runtime.emitted_sha256} bytes=${emitted.length}; deals=current-only authoritative-empty-base-visible; payments=current-only; loading-shield=opaque-overlay; runtime_dom=measurable; legacy_flash=blocked`);
