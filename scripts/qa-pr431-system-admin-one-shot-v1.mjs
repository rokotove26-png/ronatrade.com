...
for(const forbidden of ['periodic_refresh:true','pageshow_network_refresh:true','REFRESH_MS=30000','setInterval(()=>load(false)'])if(text.apps.includes(forbidden))throw new Error(`PR431_APPLICATIONS_LEGACY_REFRESH_CONTRACT_FORBIDDEN:${forbidden}`);
