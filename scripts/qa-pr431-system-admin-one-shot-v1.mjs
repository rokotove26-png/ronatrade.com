...
for(const token of ['COMPLETE_DIRECTORY_ATOMIC_COMMIT','NON_DESTRUCTIVE_KEEP_STABLE_OWNER','KEEP_LAST_VALIDATED_DIRECTORY','visual_runtime_owner:false'])if(!text.attach.includes(token))throw new Error(`PR431_ATTACH_ATOMIC_CONTRACT_MISSING:${token}`);
