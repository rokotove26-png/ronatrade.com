...
])assert.ok(!visual.includes(forbidden),`visual runtime must remain presentation-only: ${forbidden}`);
...
console.log('ADMIN_VISUAL_REDESIGN_SOURCE_V1=PASS scope=home_applications_deals client_design_tokens=reused presentation_only=true business_hooks_preserved=true passport_preserved=true');
