...
export function stableFinanceSignature(claim) {
  ...
  return JSON.stringify({
    ...
    actual_spend: mv(claim.actual_spend),
    actual_spend_status: upper(claim.actual_spend_status) || null,
    remaining_execution: mv(claim.remaining_execution),
    remaining_execution_status: upper(claim.remaining_execution_status) || null,
    execution_currency: claim.execution_currency ? upper(claim.execution_currency) : null,
    execution_status: upper(claim.execution_status) || null,
