...
async function adminSync(){
  ...
  const paymentAllocations=await sql`
    select p.payment_id,p.currency,
           ...
           pa.accounting_closure_status::text accounting_closure_status,
