...
set provider='OPENAI',
    ...
    last_error_code='OPENAI_PROVIDER_SWITCH_PENDING_PROBE',
    last_error_at=now(),
    activated_at=null,
    updated_at=now()
...
begin
  ...
  if c.provider <> 'OPENAI' then raise exception 'AI_EXECUTOR_PROVIDER_MISMATCH'; end if;
